test_that("extractColName works",{
  ...
  colname <- extractColName("tbl_analysesData", col_type = "id")
  expect_equal(colname, tbl_analysesDataNames$id)
})
