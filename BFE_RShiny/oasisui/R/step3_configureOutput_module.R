...
#'     column(4,
#'            h4("Ground Up Loss", class = "oasisui-loss"),
#'            h5("Full Sample", class = "oasisui-measure"),
#'            h5("ELT", class = "oasisui-measure"),
#'            tags$div(class = "h5-align", h5("AEP", class = "oasisui-measure")),
#'            tags$div(class = "h5-align", h5("OEP", class = "oasisui-measure")),
#'            tags$div(class = "h5-align", h5("Multi AEP", class = "oasisui-measure")),
#'            h5("Multi OEP", class = "oasisui-measure"),
#'            # h5("WS Mean AEP", class = "oasisui-measure"),
#'            # tags$div(class = "h5-align", h5("WS Mean OEP", class = "oasisui-measure")),
#'            # tags$div(class = "h5-align", h5("Sample Mean AEP", class = "oasisui-measure")),
#'            # h5("Sample Mean OEP", class = "oasisui-measure"),
#'            h5("AAL", class = "oasisui-measure"),
#'            tags$div(class = "h5-align", h5("PLT", class = "oasisui-measure"))),
#'
#'     tags$div(class = "multicol",
#'              checkboxGroupInput(ns("chkgulprog"),
#'                                 label = h6("Prog", class = "oasisui-granularity"),
#'                                 choices = LosstypesChoices,
#'                                 selected = varsdf$vars[varsdf$defaultChoice]),
#'
#'              checkboxGroupInput(ns("chkgulstate"),
#'                                 label = h6("State", class = "oasisui-granularity"),
#'                                 choices = LosstypesChoices,
#'                                 selected = NULL),
#'
#'              checkboxGroupInput(ns("chkgulcounty"),
#'                                 label = h6("County", class = "oasisui-granularity"),
#'                                 choices =LosstypesChoices,
#'                                 selected = NULL),
#'
#'              checkboxGroupInput(ns("chkgulloc"),
#'                                 label = h6("Location", class = "oasisui-granularity"),
#'                                 choices = LosstypesChoices,
#'                                 selected = NULL),
#'
...
#'   fluidRow(
#'     column(4,
#'            h4("Insured Loss", class = "oasisui-loss"),
#'            h5("Full Sample", class = "oasisui-measure"),
#'            h5("ELT", class = "oasisui-measure"),
#'            tags$div(class = "h5-align", h5("AEP", class = "oasisui-measure")),
#'            tags$div(class = "h5-align", h5("OEP", class = "oasisui-measure")),
