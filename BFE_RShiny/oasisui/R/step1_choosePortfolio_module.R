...
panelLinkFiles <- function(id) {
  ...
  oasisuiPanel(
    ...
    fluidRow(
      ...
      column(2,
             oasisuiButton(inputId = ns("abuttonSLFileUpload"), label = "Link File", align = "left", enable = FALSE, style = "margin-top: 25px;display-inline: true;")),
      # Source Account File
      column(3,
             fileInput(inputId = ns("SAFile"), label = 'Account file:',
                       accept = c('csv', 'comma-separated-values', '.csv'))),
      column(2,
             oasisuiButton(inputId = ns("abuttonSAFileUpload"), label = "Link File", align = "left",
    ...
    fluidRow(
      ...
      column(3,
             fileInput(inputId = ns("SRFile"), label = 'RI info file:',
                       accept = c('csv', 'comma-separated-values', '.csv'))),
      column(2,
             oasisuiButton(inputId = ns("abuttonSRFileUpload"), label = "Link File", align = "left",
                            style = "margin-top: 25px;display-inline: true;")),
      ...
      column(3,
             fileInput(inputId = ns("SRSFile"), label = 'RI scope file:',
                       accept = c('csv', 'comma-separated-values', '.csv'))),
      column(2,
             oasisuiButton(inputId = ns("abuttonSRSFileUpload"), label = "Link File", align = "left",
                            style = "margin-top: 25px;display-inline: true;"))),
    fluidRow(
      column(12,
