...
After having downloaded the app, the user will be prompted to login. 
...
To view the admin mode, the credentials are:
...
Tables summarize information regarding portfolio and analyses. Their statuses are represented by icons:
...
```
  ...
  - Stripy button: to select a previously run analysis 
```{r, fig.align='center', out.width = "30px", out.height = "30px", echo = FALSE}
...
```{r, fig.align='center', out.width = "30px", out.height = "30px", echo = FALSE}
knitr::include_graphics("~/RStudioProjects/OasisLMFUI/BFE_RShiny/oasisui/documentation/landing_page/user_btn.png")
```
...
```
In case no portfolio was previously created, the table will show as empty. In order to create a portfolio, a name is mandatory. 
```{r, fig.align='center', out.width = "200px", out.height = "200px", echo = FALSE}
...
### Configure Ouput & Run
In the third step, the user can create the selection of a new the configuration for a run. 
```{r, fig.align='center', out.width = "200px", out.height = "200px", echo = FALSE}
