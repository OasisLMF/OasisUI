...
By clicking on the refresh button on the top right, the status of the portfolio will then change from “In Progress” to “Completed” or "Failed". When the status of the portfolio is “Ready”, then it is possible to move forward to the second step by clicking on **Proceed to Choose Analysis**. 
